...
if (isset($_POST['login_id']) and isset($_POST['password'])) {
	...
	if (!empty($_POST['login_id']) and !empty($_POST['password'])) {
		...
		$sql = "SELECT `email` FROM admins WHERE email = '$login_id' ";
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      <li class="nav-item active">
        <span class="nav-link" style="color:white">ADMINS PORTAL</span>
      </li>
