...
<!-- Image and text -->
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="logout.php" style="color: rgb(255, 100, 100);">Logout</a>
      </li>
                ...
                <div class="card-body">
                  ...
                  <div class="row" style="">
                    <div class="col-sm-12">
                      ...
                      if (putme_completed()){
                        echo "<a class='btn btn-success' target='__blank' href='./view_application.php' >VIEW/PRINT APPLICATION</a>";
                      }else{
                        echo "<a class='btn btn-info' target='__blank' href='./start_screeing.php' >BEGIN POST UTME SCREENING</a>";
                      }
